...
public class WorkoutSessionController {
    ...
    // POST /workout-sessions - Registra uma sessão realizada [cite: 173]
    @PostMapping
    public ResponseEntity<Void> registrar(
            @Valid @RequestBody WorkoutSessionRequest request,
            @AuthenticationPrincipal Usuario usuarioLogado) {

        // Log de entrada (Requisito Sprint 3) [cite: 230]
    ...
    // GET /exercises/{id}/personal-record - Consulta o Recorde Pessoal [cite: 176]
